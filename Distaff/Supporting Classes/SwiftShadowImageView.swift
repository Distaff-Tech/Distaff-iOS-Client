...
//    @IBInspectable override var border_Color: UIColor  { didSet { self.layer.borderColor = self.border_Color.cgColor } }
//    @IBInspectable override var borderWidth: CGFloat { didSet { self.layer.borderWidth = self.borderWidth } }
